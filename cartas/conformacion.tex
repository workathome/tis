...
\item {\bf E-mail: } workathome@gmail.com
\item {\bf Socios: } 
\begin{itemize}
...
\includepdf[pages={2}]{../hojas_de_vida/erikc_cv.pdf}
\includepdf[pages={2}]{../hojas_de_vida/michel_cv.pdf}
\includepdf[pages={2}]{../hojas_de_vida/ubaldino_cv.pdf}
